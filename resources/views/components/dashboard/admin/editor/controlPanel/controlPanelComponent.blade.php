<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Editor Control Panel</h1>

    <!-- Dynamic Class Cards -->
    <div class="row editorCardsRow">

        <!-- Loader (Optional) -->
        <div class="col-12 text-center py-5" id="editorLoader">
...
<script>
    ...
    async function getClassListsForCards() {
        ...
        try {
            const response = await axios.post('/admin_db/editor/list', {}, {
                headers: {
            ...
            if (response.data.status === 'success') {
                let lists = response.data.editorLists;

                $("#editorLoader").remove(); // Remove loader
                                    ...
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex gap-2 mt-3">
                                                <button class="btn btn-sm btn-primary editorHubBtn" data-id="${element.id}">
                                                   Go EditorHub
                                                </button>
                                            </div>
                                        </div>
        ...
        //class hub button
        $(".editorHubBtn").click(function (event) {
