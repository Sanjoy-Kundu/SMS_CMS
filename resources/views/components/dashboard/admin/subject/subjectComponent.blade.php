         ...
         <div class="col-xl-7 col-md-6 mb-4">
                     ...
                     <div class="form-group mb-3">
                         <div class="input-group">
                             <input type="text" class="form-control" id="subjectSearch"
                                 placeholder="Search by Subject Name, Code, Class or Division...">
             ...
             <div class="card border-left-danger shadow mt-3">
                 ...
                 <div class="card-body">
                     ...
                     <div class="form-group mb-3">
                         <div class="input-group">
                             <input type="text" class="form-control" id="trashedSubjectSearch"
                             ...
                             <div class="input-group-append">
                                 ...
                                 <button class="btn btn-outline-secondary" type="button"
                                     id="clearTrashedSubjectSearchBtn">
                                     <i class="fas fa-times"></i> Clear
                                 </button>
                             </div>
                         </div>
     ...
     async function getSubjectForEdit(id) {
         ...
         try {
             ...
             if (response.data.status === 'success') {
                 ...
                 if (subject.class_id) {
                     await getDivisionsByClass(subject.class_id, '#editDivisionDropdownContainer',
                         '#edit_division_id');
