    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editor_address_update_Form">
                    <!-- Editor ID -->
...
<script>
    ...
    async function fillUpdateAddressForm(id) {
        ...
        try {
            let res = await axios.post('/editor/address/by-id', { id }, {
            ...
            if(res.data.status === 'success'){
                ...
                const form = document.getElementById('editor_address_update_Form');
    ...
    async function updateEditorAddress(event){
        ...
        try{
            let res = await axios.post('/editor/address/update', formData, {
                headers: {
