<!-- Modal -->
<div class="modal fade" id="editorChangePasswordModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="changePasswordModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editorChangePasswordModalLabel">Editor Password Change</h5>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label>Email</label>
                    <input type="email"  name="email" class="form-control password_profile_email" readonly>
                </div>
                <div class="mb-3">
                    <label>Current Password</label>
                    <input type="password" name="current_password" class="form-control password_current_password"
                        required placeholder="Current Password">
                </div>
                <div class="mb-3">
                    <label>New Password</label>
                    <input type="password"  name="new_password" class="form-control password_new_password" required placeholder="New Password">
                </div>
                <div class="mb-3">
                    <label>Confirm New Password</label>
                    <input type="password" name="new_password_confirmation" class="form-control confirm_password"
...
<script>
    async function editorFillUpdatePasswordForm(email) {
    ...
    async function updatePassword() {
        ...
        //console.log(data);
        try {
            let res = await axios.post('/editor/password/update', data, {
                headers: {
