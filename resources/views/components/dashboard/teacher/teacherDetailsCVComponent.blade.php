<!-- Modal -->
<div class="modal fade" id="teacherDetailsCVFormatModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    aria-labelledby="teacherDetailsCVFormatModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body" id="teacherCVContent">
                <p>Loading...</p>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                    id="addressModalClose">Close</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    async function teacherDetailsCVFormat(email) {
        ...
        document.getElementById('teacherCVContent').innerHTML = '<p>Loading...</p>';

        try {
            let res = await axios.post('/teacher/cv-details', {
                email: email
            }, {
                headers: {
    ...
    `;
                ...
                document.getElementById('teacherCVContent').innerHTML = html;

            } else {
                document.getElementById('teacherCVContent').innerHTML =
