    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="teacherEducaionl_qualificationUpdateForm">
                    ...
                    <button type="submit" class="btn btn-success" onclick="updateTeacherEducationInfo(event)">Update Education</button>
                </form>
            </div>
...
<script>
    ...
    async function fillUpdateEducationForm(id) {
        ...
        const form = document.getElementById('teacherEducaionl_qualificationUpdateForm');
        form.querySelector('input[name="id"]').value = id;

        try {
            let res = await axios.post('/teacher/education/by-id', { id }, {
    ...
    // Update Education
    // ============================
    async function updateTeacherEducationInfo(event) {
        ...
        try {
            let res = await axios.post('/teacher/education/update', data, {
                headers: { Authorization: `Bearer ${token}` }
            });
            ...
            if(res.data.status === 'success'){
                ...
                if(typeof getTeacherEducationLists === 'function'){
