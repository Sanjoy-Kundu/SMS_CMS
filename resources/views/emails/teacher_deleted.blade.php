...
<body style="font-family: Arial, sans-serif; background-color:#f4f4f4; margin:0; padding:0;">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td align="center" style="padding: 30px 0; background-color: #a60000; color:#fff;">
        ...
        <tr>
            <td style="padding: 20px;">
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; margin:0 auto; background:#fff; border:1px solid #ddd; border-radius:6px;">
                    <tr>
                        <td style="padding: 20px;">
                            <h2 style="color:#a60000; font-size:18px;">Dear {{ $teacherName }},</h2>
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                We regret to inform you that your profile has been permanently deleted 
                                from the <strong>AB School & College</strong> system.
                            </p>
                            ...
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                ...
                                administration office immediately for clarification.
                            </p>
