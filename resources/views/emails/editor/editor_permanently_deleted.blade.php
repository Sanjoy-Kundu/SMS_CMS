...
<head>
    <meta charset="UTF-8">
    <title>Editor Account Deleted</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                We regret to inform you that your <strong>Editor account</strong> associated with <strong>{{ $institutionName }}</strong> has been <strong>permanently deleted</strong> from our system.
                            </p>
                            ...
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                If you have any questions, please contact the administration office immediately.
                            </p>
