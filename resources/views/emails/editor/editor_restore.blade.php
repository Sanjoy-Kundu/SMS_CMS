                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                Good news! Your <strong>Editor account</strong> associated with <strong>{{ $institutionName }}</strong> has been <strong>restored</strong> by the administration. 
                            ...
                            <p style="color:#555; font-size:14px; line-height:1.6;">
                                If you face any issues accessing your account, please contact the administration immediately.
                            </p>
